    ...
    public CGUI( String title ) throws HeadlessException
      {
        ...
        MyActionListener.setGoReg( goup, nickup, passup );
    ...
    private void $$$setupUI$$$( )
      {
        ...
        nickin.setForeground( new Color( -1 ) );
        ...
        panel1.add( firstP, new GridConstraints( 0, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 1, false ) );
        firstP.setBorder( BorderFactory.createTitledBorder( BorderFactory.createEmptyBorder( 50, 10, 50, 10 ), null, TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null ) );
        signin = new JButton( );
